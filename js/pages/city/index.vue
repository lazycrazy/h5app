<template>
    <div class='city_container'>
        ...
        <form class='search_form' @submit.prevent>
            <input type="search" name='city' v-model="searchValue" class='search_value' placeholder="输入学校、商务楼、地址" required/>
            <input type='submit' name='submit' @click='postpois' class='search_submit' value='提交' />
        </form>
        <header v-if='!searchValue' class='history_title'>搜索历史</header>
        <ul class='placelist'>
        ...
        <div v-if='placeNone' class='search_none'>无搜索结果</div>
    </div>
</template>
<script>
