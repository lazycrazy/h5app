<template>
    <div class="user-info-page">
        ...
        <section class="profile-info">
            ...
            <router-link to="/profile/userInfo/address" class="info-router">
            ...
            <section class="info-router" @click="changePhone">
                <section class="headportrait headportraitwo headportraithree">
                    <h2><img src="../../../img/bindphone.png" style="display:inline-block;margin-right:.4rem;" alt="">手机</h2>
                    <div class="headportrait-div">
                        <p>{{infotel}}</p>
                        <span class="headportrait-div-bottom">
                                <svg fill="#d8d8d8">
            ...
            async uploadAvatar() {
                if (this.userInfo) {
                    ...
                    try {
                        ...
                        this.SET_AVATAR(this.getImagePath(res))
                    } catch (error) {
                        this.showAlert = true
                        this.alertText = '上传失败'
