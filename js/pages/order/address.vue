<template>
    <div class="address-page">
        <head-top headTitle="选择地址" :goback='true'></head-top>
        <router-link to="/confirmOrder/address/addAddress" class="address-page-add">
            <img src="../../../img/add_address.png" height="24" width="24">
            <span>新增收货地址</span>
        </router-link>
...
export default {
    ...
    computed: {
        ...mapState([
            'userInfo', 'addressIndex', 'addresses'
        ]),
