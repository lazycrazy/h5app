<template>
    <div class="download-page">
        <head-top head-title="下载" :goback='true'></head-top>
        <section class="dowload_container">
            <img src='../../img/elmlogo.png' class="logo_img">
            <p>下载饿了么APP</p>
...
export default {
    data() {
        ...
        methods: {
            download() {
                window.open("http://static10.elemecdn.com/uploads/androidapp/eleme6_4_1476672934695.apk",'_parent')
                //如果是ios用户则提示，否则直接下载
                if (this.system == 'IOS') {
                    this.showAlert = true;
