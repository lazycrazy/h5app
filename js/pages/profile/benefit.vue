<template>
    <div class="rating_page">
        <head-top head-title="我的优惠" :goback='true'></head-top>
        <section v-if="!showLoading">
            ...
            <transition name="router-fade">
                <section v-if="categoryType === 1">
                    <section class="hongbao_container">
                        <header class="hongbao_title">
                            ...
                            <section class="hongbao_description">
                                <img src="../../../img/description.png" height="24" width="24">
                                <a to="/benefit/hbDescription" class="hongbao_detail">红包说明</a>
                            </section>
                        </header>
                    ...
                    <a to="/benefit/hbHistory" class="history_hongbao">
                    ...
                    <footer class="hongbao_footer">
                        <a to="/benefit/exchange" class="hongbao_style" style="border-right: 1px solid #f5f5f5">
                            兑换红包
                        </a>
                        <a to="/benefit/commend" class="hongbao_style">
                            推荐有奖
                        </a>
                    </footer>
                </section>
            ...
            <transition name="router-fade">
                <section v-if="categoryType === 2" class="voucher_container">
                    <section class="hongbao_description voucher_header">
                        <img src="../../../img/description.png" height="24" width="24">
                        <a to="/benefit/coupon" class="hongbao_detail">商家代金券说明</a>
                    </section>
                    <section class="unable_use">
                        <img src="../../../img/voucher.png" height="170" width="300">
                        <p>无法使用代金券</p>
                        <p>非客户端或客户端版本过低</p>
...
.hongbao_container {
    ...
    .hongbao_list_ul {
        .hongbao_list_li {
            background: #fff url(../../../img/hongbao.png) repeat-x;
